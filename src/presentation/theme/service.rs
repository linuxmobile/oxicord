...
impl Theme {
    ...
    pub fn from_palette<P: Palette>(
        ...
        Self {
            ...
            tab_style: palette.tab_style(base_color),
            tab_selected_style: palette.tab_selected_style(),
            statusbar_style: palette.statusbar_style(base_color),
            ...
            dimmed_style: palette.dimmed_style(base_color),
            ...
            border_style: palette.border_style(base_color),
            timestamp_style: palette.timestamp_style(base_color),
        }
    }
